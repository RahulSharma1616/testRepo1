...
export default function Timesheet() {
  ...
  // Get all the holidays from holidays api for the logged in user
  useEffect(() => {
    setIsLoading(true);
    axios({
      method: "get",
      url: "http://localhost:4000/user/getHolidays",
      headers: {
  ...
  return (
    <div style={{ overflow: "hidden !important" }}>
      ...
      <div className="timesheet-container" style={{ marginLeft: "90px" }}>
        ...
        <table className="table ms-4">
          <thead className="table-secondary" s>
            <tr>
              <th
                style={{
                  fontSize: "26px",
